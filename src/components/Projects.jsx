...
const Projects = () => {
  return (
    <section className='px-6 py-10' id='project'>
        <h1 className='text-4xl md:text:6xl font-medium tracking-tight mb-8'>Projects</h1>
                ...
                variants={projectVariants}>
                    ...
                    <div className='relative z-20 p-6 flex flex-col justify-between h-full bg-black/30 text-white'>
                        ...
                        <div className='flex flex-col justify-between'>
                            ...
                            <a href={project.link} className='bg-white text-stone-900 rounded-full py-2 px-2 w-32 text-sm hover:bg-gray-100 text-center'>
                                View on Github
                            </a>
                        </div>
                    </div>    
