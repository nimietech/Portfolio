...
const Contact = () => {
  ...
  const sendToWhatsApp = (e) => {
    ...
    const phoneNumber = "2349079070943";
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center px-4 md:px-10" id="contact">
      ...
      <h2 className="text-4xl md:text-6xl font-medium tracking-tight mb-8 ">Contact</h2>
      <div className="h-1 w-20 mb-8 bg-white mr-11"></div>
      ...
      <div className="max-w-3xl mt-10 rounded-xl shadow-lg p-8">
        <form ref={form} onSubmit={sendToWhatsApp} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              name="user_email"
              required
              className="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 bg-white dark:text-black"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 bg-amber-950 text-white font-medium text-lg py-2 px-4 rounded-md transition duration-300"
          >
            📩 Send via WhatsApp
          </button>
        </form>
        ...
        {success && (
          <p className="text-green-600 text-sm mt-4 text-center">
            ✅ WhatsApp message ready! Just hit Send.
          </p>
        )}
      </div>

      <div className="text-center pt-10">{CONTACT_CONTENT.footerText}</div>
    </section>
  );
};
